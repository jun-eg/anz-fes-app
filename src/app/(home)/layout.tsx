import { getAllShiftData, getLatestShiftData } from "@/actions/shiftAction";
...
const HomeLayout = async ({ children }: { children: ReactNode }) => {
  let initialShiftDatas: Awaited<ReturnType<typeof getAllShiftData>> = [];

  try {
    initialShiftDatas = await getAllShiftData();
  } catch (error) {
    const message =
